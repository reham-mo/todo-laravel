...
<body>
    ...
    <div class="container">
        ...
        <form class="row g-3" action="{{ url('/task') }}" method="post" enctype="multipart/form-data">
            @csrf
            ...
            <div class="col-12">
                ...
                <input type="text" class="form-control" id="inputAddress2" placeholder="Enter Title" name="title" value="{{ old('title') }}">
            </div>

            <div class="col-12">
                <label for="inputEmail4" class="form-label">Content</label>
                <input type="text" class="form-control" id="inputEmail4" placeholder="Enter Content" name="content" value="{{ old('content') }}">
            </div>
